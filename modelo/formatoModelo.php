...
class formatoModelo
{
    ...
    public static function mdlAgregarFormato($nombre,$documento,$cargo,$telefono,$email,$direccion,$estudios1,$estudios2,$estudios3,$estudios4,$experiencia1,$experiencia2,$experiencia3,$habilidades1,$habilidades2,$habilidades3,$referencias1,$referencias2,$referencias3)
    {
        $mensaje = array();
        try {
            $objRespuesta = Conexion::conectar()->prepare("INSERT INTO hoja_de_vida(nombre,documento,cargo,telefono,email,direccion,estudios1,estudios2,estudios3,estudios4,experiencia1,experiencia2,experiencia3,habilidades1,habilidades2,habilidades3,referencias1,referencias2,referencias3) VALUES(:nombre,:documento,:cargo,:telefono,:email,:direccion,:estudios1,:estudios2,:estudios3,:estudios4,:experiencia1,:experiencia2,:experiencia3,:habilidades1,:habilidades2,:habilidades3,:referencias1,:referencias2,:referencias3)");
