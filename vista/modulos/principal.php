            ...
            <div class="card-group vgr-cards">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Con esta Plantilla tu podras adjuntar toda la informacion que necesites, de
                            manera completa y organizada; para una Hoja de vida de calidad para cualquier empresa.</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Si eres aprendiz Sena, esta Plantilla es perfecta para ti, ya que tu podras
                            adjuntar toda la informacion que sea necesaria, en base al formato principal que dispone el
                            SENA para una Hoja de Vida completa y de calidad; con la cual podras presentarte a cualquier
                            empresa en tu etapa Practica.</p>
