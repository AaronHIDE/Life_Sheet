<div class="container">
    <FONT SIZE="6" FACE="Cooper Black" COLOR="black" class="h1" align="center">FORMATO DE HOJAS DE VIDA DEL SENA</FONT>
    <br><br><br><br><br>
    <div class="row">
                            ...
                            <table class="table table-bordered" id="inventario">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="vista/imagenes/life_sheet_logo0.png"
                                        ...
                                        <td>
                                            <div class="container nombre-container">
                                                <div class="inputboxf">
                                                    ...
                                                    <label for="nombres_apellidos" class="form-label">
                                        ...
                                        <td>
                                            <div class="inputboxf">
                                                <ion-icon name="document-text"></ion-icon>
                                                <input type="email" class="form-control" id="email_misena"
                                                    name="email_misena" required>
                                                <label for="email_misena" class="form-label">
                                                    <FONT SIZE="6 " FACE="Montserrat" COLOR="black" class="h5">
                                                        Email MiSena:</FONT>
                                                </label>
                                            </div>
                                        ...
                                        <td>
                                            <div class="inputboxf">
                                                ...
                                                <input type="text" class="form-control" id="libreta_militar"
                                                    name="libreta_militar" required>
                                                <label for="libreta_militar" class="form-label">
                                                    <FONT SIZE="6 " FACE="Montserrat" COLOR="black" class="h5">
                                                        Libreta Militar:</FONT>
                                                </label>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="inputboxf">
                                                ...
                                                <input type="text" class="form-control" id="titulo_obenido"
                                            ...
                                            <div class="inputboxf">
                                                ...
                                                <label for="institucion_educativa" class="form-label">
                                                    <FONT SIZE="6 " FACE="Montserrat" COLOR="black" class="h5">Institución Educativa:
                                                    </FONT>
                                                </label>
                                            </div>
                                            <div class="inputboxf">
                                                ...
                                                <input type="date" class="form-control" id="fecha_grado" name="fecha_grado"
                                                    required>
                                                <label for="fecha_grado" class="form-label">
                                                    <FONT SIZE="6 " FACE="Montserrat" COLOR="black" class="h5">Fecha de Grado:
                                                    </FONT>
                                                </label>
                                            </div>
                                            <div class="inputboxf">
                                                ...
                                                <input type="text" class="form-control" id="nombre_estudios" name="nombre_estudios"
                                                    required>
                                                <label for="nombre_estudios" class="form-label">
                                                    <FONT SIZE="6 " FACE="Montserrat" COLOR="black" class="h5">
                                                        Nombre de los Estudios:</FONT>
                                                </label>
                                            </div>
                                            <br>
                                            ...
                                            <div class="inputboxf">
                                                <ion-icon name="call"></ion-icon>
                                                <input type="text" class="form-control" id="institucion_educativa2" name="institucion_educativa2"
                                                    required>
                                                <label for="institucion_educativa2" class="form-label">
                                                    <FONT SIZE="6 " FACE="Montserrat" COLOR="black" class="h5">Institución Educativa Nº2:
                                                    </FONT>
                                                </label>
                                            </div>
                                        </td>
                                        <div class="inputboxf">
                                                <ion-icon name="call"></ion-icon>
                                                <input type="number" class="form-control" id="semestres_aprobados" name="semestres_aprobados"
                                                    required>
                                                <label for="semestres_aprobados" class="form-label">
                                                    <FONT SIZE="6 " FACE="Montserrat" COLOR="black" class="h5">Semestres Aprobados:
                                                    </FONT>
                                                </label>
                                            </div>
                                        <td>
                                            ...
                                            <div class="inputboxf">
                                                ...
                                                <label for="nombre_programa" class="form-label">
                                                    <FONT SIZE="6 " FACE="Montserrat" COLOR="black" class="h5">Nombre del Programa:
                                                    </FONT>
                                                </label>
                                            </div>
                                            <div class="inputboxf">
                                                ...
                                                <label for="ficha" class="form-label">
                                                    <FONT SIZE="6 " FACE="Montserrat" COLOR="black" class="h5">Número de Ficha:
                                                    </FONT>
                                                </label>
                                            </div>
                                            <div class="inputboxf">
                                            ...
                                            <div class="inputboxf">
                                                <ion-icon name="library"></ion-icon>
                                                <input type="text" class="form-control" id="centro_formacion" name="centro_formacion"
                                                    required>
                                                <label for="centro_formacion" class="form-label">
                                                    <FONT SIZE="6 " FACE="Montserrat" COLOR="black" class="h5">
                                                        Centro de Formación:</FONT>
                                                </label>
                                            </div>
                                            <div class="inputboxf">
                                                <ion-icon name="library"></ion-icon>
                                                <input type="point" class="form-control" id="ciudad_formacion" name="ciudad_formacion"
                                                    required>
                                                <label for="ciudad_formacion" class="form-label">
                                                    <FONT SIZE="6 " FACE="Montserrat" COLOR="black" class="h5">
                                                        Ciudad de Formación:</FONT>
                                                </label>
                                            </div>
                                            <div class="inputboxf">
                                                <ion-icon name="library"></ion-icon>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="inputboxf">
                                                <ion-icon name="library"></ion-icon>
                                                <input type="text" class="form-control" id="coordinador_academico" name="coordinador_academico"
                                                    required>
                                        ...
                                        <td>
                                            ...
                                            <div class="inputboxf">
                                                ...
                                                <input type="text" class="form-control" id="nombre_funcionario"
                                                    name="nombre_funcionario" required>
                                                <label for="nombre_funcionario" class="form-label">
                                                    <FONT SIZE="6 " FACE="Montserrat" COLOR="black" class="h5">
                                                        Nombre del Funcionario:</FONT>
                                                </label>
                                            </div>
                                            <div class="inputboxf">
                                                <ion-icon name="barbell"></ion-icon>
                                            ...
                                            <div class="inputboxf">
                                                ...
                                                <label for="email_funcionario" class="form-label">
                                                    <FONT SIZE="6 " FACE="Montserrat" COLOR="black" class="h5">
                                                        Email:</FONT>
                                                </label>
                                            </div>
                                        ...
                                        <td>
                                            ...
                                            <div class="inputboxf">
                                                ...
                                                <label for="centro_formacion1" class="form-label">
                                                    <FONT SIZE="6 " FACE="Montserrat" COLOR="black" class="h5">
                                                        Centro de Formación:</FONT>
                                                </label>
                                            </div>
                                            <div class="inputboxf">
                                                ...
                                                <label for="representante_legal" class="form-label">
                                                    <FONT SIZE="6 " FACE="Montserrat" COLOR="black" class="h5">
                                                        Representante Legal:</FONT>
                                                </label>
                                            </div>
                                            <div class="inputboxf">
                                                <ion-icon name="people"></ion-icon>
                                                <input type="text" class="form-control" id="email_personal1"
                                                    name="email_personal1" required>
                                                <label for="email_personal1" class="form-label">
                                                    <FONT SIZE="6 " FACE="Montserrat" COLOR="black" class="h5">
                                                        Email:</FONT>
                                                </label>
                                            </div>
