...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-5 bg-orange mr mb-5 rounded">
            <br><br>
            <FONT SIZE="6" FACE="Cooper Black" class="h2 text-dark ">¡Comparte tu hoja de vida con nosotros!</FONT>
            <br><hr>
            
            <p style="font-size:large;">Puedes compartir por nuestro correo tu hoja de vida previamente descargada como PDF.</p>
